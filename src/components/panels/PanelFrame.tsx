...
export function PanelFrame({
  ...
  return (
    <motion.section
      ...
      className="rounded-[32px] border border-white/10 bg-white/[0.055] p-5 shadow-panel backdrop-blur-xl"
    >
      <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h2 className="mt-3 font-display text-2xl tracking-[-0.04em] text-ink">
            {title}
          </h2>
